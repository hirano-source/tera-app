...
const INSTRUCTIONS = `Savo（目標達成型タスク管理）のMCP。コネクターは利用者本人として動作し、権限はサーバ側RLSで保証される。
...
const server = new McpServer({ name: 'savo', version: '0.2.0' }, { instructions: INSTRUCTIONS })
